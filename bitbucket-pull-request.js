...
module.exports = function ({ data: { actor, pullrequest, repository } }, done) {
  ...
  console.log(`${display_name} (${username}), has opened the following pull request **${title}** that says \"${description}\" from ${source.branch.name} to ${destination.branch.name}`);
